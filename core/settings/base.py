"""
Django settings for Spiritual G-Code project.
"""
...
# Security Settings
# https://docs.djangoproject.com/en/5.0/topics/http/security/
...
CRONJOBS = [
    ...
    (
        "0 4 * * *",
        "scripts.calculate_daily_gcode.calculate_all_daily_gcodes",
        ">> /tmp/gcode_calc.log",
    ),
    # Generate Spiritual Patch Notes at 5:00 AM every day
    (
        "0 5 * * *",
        "scripts.generate_patch_notes.generate_all_patch_notes",
        ">> /tmp/patch_notes.log",
    ),
