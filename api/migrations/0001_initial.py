    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "module",
                    models.CharField(
                        help_text="Python module that generated the log", max_length=100
                    ),
                ),
                (
                    "function",
                    models.CharField(
                        help_text="Function that generated the log", max_length=100
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bio",
                    models.TextField(
                        blank=True, help_text="User's bio or spiritual journey"
                    ),
                ),
                (
                    "avatar",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transit_data",
                    models.JSONField(help_text="Current planetary positions"),
                ),
                (
                    "aspects_to_natal",
                    models.JSONField(
                ...
                (
                    "affirmation",
                    models.TextField(help_text="Daily affirmation generated by AI"),
                ),
                (
                    "practical_guidance",
                    models.JSONField(help_text="Array of practical guidance tips"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hashtags",
                    models.JSONField(
                        blank=True, help_text="Array of hashtags", null=True
                    ),
                ),
                (
                    "platform",
                ...
                (
                    "scheduled_for",
                    models.DateTimeField(
                        blank=True, help_text="Scheduled posting time", null=True
                    ),
                ),
                (
                    "posted_at",
                    models.DateTimeField(
                        blank=True, help_text="Actual posting time", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sun_sign",
                    models.CharField(
                        help_text="Sun sign (e.g., 'Aries')", max_length=20
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "metadata",
                    models.JSONField(
                        blank=True, help_text="Additional activity data", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
