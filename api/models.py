...
class GCodeUser(AbstractUser):
    ...
    birth_time = models.TimeField(
        null=True, blank=True, help_text="User's birth time (optional but recommended)"
    )
    birth_location = models.CharField(
        max_length=255, help_text="Birth location (City, Country or Lat/Long)"
    )
    ...
    daily_gcode_enabled = models.BooleanField(
        default=True, help_text="Enable automatic Daily G-Code calculations"
    )
...
class NatalChart(models.Model):
    ...
    user = models.OneToOneField(
        GCodeUser, on_delete=models.CASCADE, related_name="natal_chart"
    )
    ...
    ascendant = models.CharField(max_length=20, help_text="Rising sign")
...
class DailyTransit(models.Model):
    ...
    user = models.ForeignKey(
        GCodeUser, on_delete=models.CASCADE, related_name="daily_transits"
    )
...
class GeneratedContent(models.Model):
    ...
    hashtags = models.JSONField(help_text="Array of hashtags", null=True, blank=True)

    platform = models.CharField(
        max_length=20, choices=PLATFORM_CHOICES, help_text="Target platform"
    )
    ...
    scheduled_for = models.DateTimeField(
        null=True, blank=True, help_text="Scheduled posting time"
    )

    posted_at = models.DateTimeField(
        null=True, blank=True, help_text="Actual posting time"
    )
...
class GCodeTemplate(models.Model):
    ...
    variables = models.JSONField(
        help_text="Array of variables used in the template", null=True, blank=True
    )

    # Example Output (for documentation)
    example_output = models.TextField(
        blank=True, help_text="Example of generated output"
    )
...
class UserActivity(models.Model):
    ...
    user = models.ForeignKey(
        GCodeUser, on_delete=models.CASCADE, related_name="activities"
    )
    ...
    metadata = models.JSONField(
        help_text="Additional activity data", null=True, blank=True
    )
...
class SystemLog(models.Model):
    ...
    module = models.CharField(
        max_length=100, help_text="Python module that generated the log"
    )
    function = models.CharField(
        max_length=100, help_text="Function that generated the log"
    )
