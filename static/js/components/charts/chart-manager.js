...
class DashboardChartsManager {
    ...
    async initAll() {
        if (this.isInitialized) {
            console.warn('[ChartManager] Charts already initialized');
            return;
        }

        console.log('[ChartManager] Initializing dashboard charts...');

        try {
            // Initialize G-Code Trend Chart
            console.log('[ChartManager] Initializing G-Code Trend Chart...');
            ...
            if (trendCanvas) {
                ...
                console.log('[ChartManager] ✓ G-Code Trend Chart initialized');
            }

            // Initialize Planetary Positions Chart
            console.log('[ChartManager] Initializing Planetary Positions Chart...');
            ...
            if (planetaryCanvas) {
                ...
                console.log('[ChartManager] ✓ Planetary Positions Chart initialized');
            }

            // Initialize Element Distribution Chart
            console.log('[ChartManager] Initializing Element Distribution Chart...');
            ...
            if (elementCanvas) {
                ...
                console.log('[ChartManager] ✓ Element Distribution Chart initialized');
            }

            // Initialize Weekly Forecast Chart
            console.log('[ChartManager] Initializing Weekly Forecast Chart...');
            ...
            if (forecastCanvas) {
                ...
                console.log('[ChartManager] ✓ Weekly Forecast Chart initialized');
            }

            // Initialize Aspects Network Chart
            console.log('[ChartManager] Initializing Aspects Network Chart...');
            ...
            if (networkContainer) {
                ...
                console.log('[ChartManager] ✓ Aspects Network Chart initialized');
            }

            this.isInitialized = true;
            console.log('[ChartManager] ✓ All dashboard charts initialized successfully!');
        } catch (error) {
            console.error('[ChartManager] Error initializing charts:', error);
